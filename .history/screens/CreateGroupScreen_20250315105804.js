...
// Fix the import - make sure to reinstall the package if needed
...
const CreateGroupScreen = () => {
  ...
  // Updated image picker function with direct function calls
  const pickImage = async () => {
    try {
      // Using direct function import instead of ImagePicker object
