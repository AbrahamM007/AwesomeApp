    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <TouchableOpacity style={styles.groupCard}>
          {/* Replace with colored View until you have the actual image */}
          <View 
            style={[styles.groupImage, {backgroundColor: '#8eda8e'}]} 
          />
        ...
        <TouchableOpacity style={styles.groupCard}>
          {/* Replace with colored View until you have the actual image */}
          <View 
            style={[styles.groupImage, {backgroundColor: '#a0d2eb'}]} 
          />
          <View style={styles.groupInfo}>
        ...
        <TouchableOpacity style={styles.groupCard}>
          {/* Replace with colored View until you have the actual image */}
          <View 
            style={[styles.groupImage, {backgroundColor: '#ffcfdf'}]} 
          />
          <View style={styles.groupInfo}>
