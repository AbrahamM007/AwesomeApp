...
const EventsScreen = ({ navigation }) => {
  const [events, setEvents] = useState([
    // Add some default events so the screen isn't empty
    {
      id: '1',
  ...
  // Temporarily disable AsyncStorage functions
  // useEffect(() => {
  //   loadEvents();
  // }, []);
  
  // Simplified version without AsyncStorage
  ...
  // Simplified version without AsyncStorage
  const loadEvents = () => {
    // We're using the default events in state for now
    console.log('Events loaded from state');
  };
