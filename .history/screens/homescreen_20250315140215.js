...
const styles = StyleSheet.create({
  ...
  quickActions: {
    ...
    bottomPadding: {
    height: 100, // Add padding at the bottom to ensure content is scrollable
    },
  actionButtonText: {
    color: '#fff',
    fontWeight: 'bold',
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.announcementCard}>
          <Text style={styles.announcementTitle}>SUNDAY SERVICE</Text>
          <Text style={styles.announcementDetails}>Join us every Sunday at 10:00 AM</Text>
