...
const EventsScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <StatusBar barStyle="light-content" backgroundColor="#4a6741" />
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    backgroundColor: '#4a6741', // Changed from brown to dark green
  },
  headerContent: {
    flexDirection: 'row',
  ...
  eventImagePlaceholder: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: '#a9c25d', // Add solid background color
  },
  eventImageOverlay: {
    position: 'absolute',
    bottom: 0,
