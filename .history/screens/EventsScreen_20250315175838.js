    ...
    >
      ...
      <View style={styles.eventContent}>
        ...
        <TouchableOpacity style={styles.viewDetailsButton}>
          ...
          <FontAwesome5 name="arrow-right" size={12} color="#5e3b25" />
        </TouchableOpacity>
      </View>
    </TouchableOpacity>
  );
        ...
        {loading ? (
          ...
          <>
            <View style={styles.headerBanner}>
              <Text style={styles.bannerText}>Upcoming Events</Text>
              <Text style={styles.bannerSubText}>{events.length} events found</Text>
            </View>
            <FlatList
              data={events}
