      ...
      <View style={styles.eventContent}>
        <View style={styles.eventMeta}>
          <View style={styles.metaItem}>
            <Ionicons name="time-outline" size={16} color="#7d9d62" />
            <Text style={styles.metaText}>{formatTime(item.time)}</Text>
          </View>
          <View style={styles.metaItem}>
            <Ionicons name="location-outline" size={16} color="#7d9d62" />
        ...
        <View style={styles.actionRow}>
          <TouchableOpacity style={styles.actionButton}>
            <Ionicons name="share-social-outline" size={18} color="#34495e" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.actionButton}>
            <Ionicons name="bookmark-outline" size={18} color="#34495e" />
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  loadingText: {
    marginTop: 12,
    fontSize: 16,
    color: '#4a6741', // Changed from brown to dark green
    fontWeight: '500',
  },
  emptyContainer: {
    flex: 1,
