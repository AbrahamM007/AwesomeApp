...
function CustomTabBar({ state, descriptors, navigation }) {
  ...
  const containerWidth = expandAnim.interpolate({
    inputRange: [0, 1],
    outputRange: [80, 320]  // Fixed width values for better control
  });
  ...
  // Calculate bottom position for the container
      ...
      <Animated.View style={{
        ...
        <Animated.View style={{ 
          ...
          left: expandAnim.interpolate({
            inputRange: [0, 1],
            outputRange: [5, 135]  // Center the button when collapsed and position it properly when expanded
          }),
          shadowColor: '#000',
