...
// We need to initialize Firestore and enable persistence in a specific way
// to avoid the "already started" error
const initializeFirestore = async () => {
  if (!db) {
    db = getFirestore(app);
    
    // Only try to enable persistence if db was just initialized
    try {
